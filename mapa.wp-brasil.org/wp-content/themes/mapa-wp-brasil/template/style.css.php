...
/* Title of the Blog */
#blog-title     { left:90px; position:fixed; top:30px; max-width:240px; height:150px;}
#blog-title img { max-width:240px; }
...
/* Top Menu */
.map-menu-top                       { position:fixed; right:124px; top:30px; z-index:10; }
.map-menu-top ul                    { list-style:none; margin:0; padding:0; }
.map-menu-top ul li                 { float:left; padding:0; }
.map-menu-top ul li a               { background:<?php echo $bgColor; ?>; color:<?php echo $fontColor; ?>; display:block; padding:6px 9px; font-family:"Bebas"; text-decoration:none; text-transform: uppercase; font-size: 1.5em;}
...
.map-menu-side ul li a              { background:<?php echo $bgColor; ?>; color:<?php echo $fontColor; ?>; display:block; padding:6px 9px; text-decoration:none; font-size: 1.5em; }
...
/* Filters */
#toggle-filters { display: none; background:<?php echo $themeColor; ?>; color:<?php echo $fontColor; ?>; cursor:pointer; float:right; font-weight:bold; padding:4px 14px 2px 10px; text-transform:uppercase; width:177px;}
...
#results h1 { font-size:2em; margin-bottom:25px; }
...
.result p.date { display:none; background:<?php echo $themeColor; ?>;  font-size:14px; margin-bottom:3px; padding:0 3px; }
.result p.author a { color:<?php echo $themeColor; ?>; text-decoration:none; }
.result p.author a:hover { text-decoration:underline; }

/* Ballon */
.balloon            { background:#fff; color:<?php echo $bgColor; ?>; padding:18px 0; width:290px; }
...
.balloon .date      { background:<?php echo $themeColor; ?>; color:<?php echo $fontColor; ?>; font-family:"Bebas"; font-size:18px; padding:0 3px; display:none;}
...
#post_overlay .date                         { display: none; font-family:"Bebas"; font-size:22px; }
